...
<div class="sidebar">
    ...
    <div class="nav-menu">
        ...
        <div class="nav-item"><i class="fas fa-chart-bar"></i><span>Overview</span></div>
        <div class="nav-item"><i class="fas fa-ticket-alt"></i><span>Draws</span></div>
        ...
        <div class="nav-item"><i class="far fa-credit-card"></i><span>Cards</span></div>
        <div class="nav-item"><i class="fas fa-plus-circle"></i><span>Add new address</span></div>
        <div class="nav-item"><i class="fas fa-chevron-left"></i><span>Previous</span></div>
    </div>
</div>
